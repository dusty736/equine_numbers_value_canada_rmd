...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. Horse population by province 1940 - 1972.", out.width = "100%"}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. Maximum and minimum number of horses between 1940 - 1972 by province")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = paste0("Figure 2. Horses population between 1940 - 1972 for ", params$province), out.width = '60%'}
